...
export const metadata: Metadata = { title: 'همکاری با عدل‌یار', description: 'درخواست همکاری و بررسی اطلاعات حرفه‌ای متخصصان حقوقی و کارشناسی.', alternates: { canonical: '/join' } };
