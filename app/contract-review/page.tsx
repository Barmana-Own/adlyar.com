...
export const metadata = createPageMetadata({ title: 'بررسی قرارداد', description: 'ثبت ساختاریافته نوع قرارداد، طرفین، هدف، مرحله، فایل، مهلت و نگرانی اصلی برای بررسی اولیه.', path: '/contract-review' });
