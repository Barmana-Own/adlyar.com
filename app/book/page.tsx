...
export const metadata = createPageMetadata({ title: 'رزرو مشاوره', description: 'درخواست مشاوره تلفنی، آنلاین، حضوری، مکتوب یا سازمانی با تاریخ و ساعت ترجیحی.', path: '/book' });
