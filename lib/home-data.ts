...
export const trustItems = [
  ...
  },
  {
    ...
    description: 'مدارک در بستری غیرعمومی و با دسترسی کنترل‌شده مدیریت می‌شوند.',
    icon: FileKey2,
  },
];
...
export const benefits = [
  ...
  {
    title: 'حفظ محرمانگی',
    description: 'جزئیات درخواست در چرخه کنترل‌شده بررسی می‌شود.',
    icon: LockKeyhole,
  },
  {
    title: 'شفافیت فرآیند',
...
export const securityFeatures = [
  {
    title: 'محرمانگی',
    description: 'اصل دسترسی محدود در تمام مسیر بررسی درخواست رعایت می‌شود.',
    icon: LockKeyhole,
  },
  {
    title: 'دسترسی کنترل‌شده',
    description: 'هر نقش فقط به اطلاعات لازم برای همان مرحله دسترسی دارد.',
    icon: Fingerprint,
  },
  {
    title: 'ذخیره‌سازی غیرعمومی',
    description: 'مدارک پرونده به‌عنوان محتوای عمومی منتشر نمی‌شوند.',
    icon: FileKey2,
  },
  {
    title: 'لینک‌های امن',
  ...
  {
    title: 'کنترل دسترسی',
    description: 'سطح مشاهده و اقدام بر اساس مسئولیت هر فرد تعریف می‌شود.',
    icon: UsersRound,
  },
  {
    title: 'ثبت رویدادهای امنیتی',
    description: 'رویدادهای مهم دسترسی برای پیگیری و بررسی ثبت می‌شوند.',
    icon: FileClock,
  },
];
